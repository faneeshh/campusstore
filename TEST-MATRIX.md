...
| T04 | Customer registration | Register with alice@example.com; confirm redirect to login | Redirect to /login with success message | Redirected to /login?registered=true after successful registration |
